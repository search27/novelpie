!function(e) {
    ...
    var e, qe = {
        ...
        disabled: !1,
        offset: null
    }, Ie = [], Ve = !!/msie/i.exec(window.navigator.userAgent), We = ((e = document.createElement("div").style).cssText = "background-color:rgba(0,0,0,.5)",
    t(e.backgroundColor, "rgba") || t(e.backgroundColor, "hsla")), Be = ["<button type='button' class='sp-replacer'>", "<span class='sp-preview'><span class='sp-preview-inner'></span></span>", "<span class='sp-dd'>&#9660;</span>", "</button>"].join(""), Ke = function() {
        var e = "";
        if (Ve)
            for (var t = 1; t <= 6; t++)
    ...
    function $e(e, t, a, o) {
        for (var r = [], n = 0; n < e.length; n++) {
            ...
            if (s) {
                ...
                r.push('<span class="sp-thumb-el sp-clear-display" role="button" tabindex="0"><span class="sp-clear-palette-only" style="background-color: transparent;"></span></span>')
        }
    ...
    function n(e, t) {
        var a, o, r, n, h = function(e, t) {
            ...
            a
        }(t, e), s = h.type, d = "flat" == s, i = h.showSelectionPalette, l = h.localStorageKey, c = h.theme, u = h.callbacks, f = (a = Oe,
        function() {
            var e = this
              , t = arguments;
            r && clearTimeout(n),
            !r && n || (n = setTimeout(function() {
                n = null,
                a.apply(e, t)
            }, o))
        }
        ), p = !(o = 10), g = !1, b = 0, m = 0, v = 0, x = 0, y = 0, T = 0, w = 0, _ = 0, k = 0, P = 0, C = 1, S = [], M = [], z = {}, j = h.selectionPalette.slice(0), A = h.maxSelectionSize, R = "sp-dragging", F = !1, H = null, L = e.ownerDocument, O = (L.body,
        Ne(e)), Q = !1, E = Ne(Ke, L).addClass(c), N = E.find(".sp-picker-container"), D = E.find(".sp-color"), q = E.find(".sp-dragger"), I = E.find(".sp-hue"), V = E.find(".sp-slider"), W = E.find(".sp-alpha-inner"), B = E.find(".sp-alpha"), K = E.find(".sp-alpha-handle"), $ = E.find(".sp-input"), X = E.find(".sp-palette"), Y = E.find(".sp-initial"), G = E.find(".sp-cancel"), U = E.find(".sp-clear"), J = E.find(".sp-choose"), Z = E.find(".sp-palette-toggle"), ee = O.is("input"), te = (ee && "color" === O.attr("type") && Ue(),
        ee && "color" == s), ae = te ? Ne(Be).addClass(c).addClass(h.className).addClass(h.replacerClassName) : Ne([]), oe = te ? ae : O, re = ae.find(".sp-preview-inner"), ne = h.color || ee && O.val(), se = !1, ie = h.preferredFormat, le = !h.showButtons || h.clickoutFiresChange, ce = !ne, ue = h.allowEmpty, fe = null, he = null, de = null, pe = null, ge = O.attr("id");
        ...
        function me() {
            if (h.showPaletteOnly && (h.showPalette = !0),
        ...
        function ye() {
            ...
            }(), a, "sp-palette-row sp-palette-row-selection", h)),
            X.html(e.join(""))
        }
        function Te() {
            if (h.showInitial) {
        ...
        function ke(e) {
            if (F)
                ...
                t.isValid() ? (je(t),
                Re(),
                Le()) : $.addClass("sp-validation-error")
            } else
                je(null),
                Re(),
                Le()
        ...
        function Pe() {
            ...
            p ? Oe() : (O.trigger(e, [Ae()]),
            !1 === u.beforeShow(Ae()) || e.isDefaultPrevented() || (function() {
        ...
        function je(e, t) {
            var a, o;
            tinycolor.equals(e, Ae()) ? Fe() : (e && e !== De || !ue ? (ce = !1,
        ...
        function Ae(e) {
            return e = e || {},
            ue && ce ? null : tinycolor.fromRatio({
                h: _,
                s: k,
                v: P,
        ...
        function Re() {
            Fe(),
            u.move(Ae()),
            O.trigger("move.spectrum", [Ae()])
        }
        function Fe() {
            $.removeClass("sp-validation-error"),
            He();
            ...
            var a = Ae({
              ...
              , o = "";
            if (re.removeClass("sp-clear-display"),
            ...
            !a && ue)
                ...
                var r = a.toHexString()
                  , n = a.toRgbString();
                if (We || 1 === a.alpha ? re.css("background-color", n) : (re.css("background-color", "transparent"),
            ...
            "text" == h.type || "component" == h.type) {
                ...
                if (c && he) {
                    ...
                    he.css("background-color", pe).css("color", de)
            }
            h.showPalette && ye(),
            Te()
        }
        ...
        function Oe() {
            ...
            y = B.width(),
            T = K.width(),
            d || (E.attr("aria-haspopup", !0),
            E.css("position", "absolute"),
            h.offset ? E.offset(h.offset) : E.offset((t = oe,
            a = (e = E).outerWidth(),
            o = e.outerHeight(),
            r = t.outerHeight(),
            n = e[0].ownerDocument,
        ...
        !function() {
            if (Ve && E.find("*:not(input)").attr("unselectable", "on"),
            me(),
            ...
            te)
                ...
                e.width(O.outerHeight() + "px").css("border-radius", O.css("border-radius")).css("border", O.css("border")),
                O.addClass("with-add-on").before(e)
            }
            if (he = O.parent().find(".sp-colorize"),
            de = he.css("color"),
            ...
            d)
                ...
                1 !== t.length && (t = Ne("body")),
                t.append(E)
            }
            function a(e) {
                return e.data && e.data.ignore ? (je(Ne(e.target).closest(".sp-thumb-el").data("color")),
                Re()) : (je(Ne(e.target).closest(".sp-thumb-el").data("color")),
                Re(),
                h.hideAfterPaletteSelect ? (Le(!0),
                Me()) : Le()),
                !1
            }
            ve(),
            ...
            J.on("click.spectrum", function(e) {
                ...
                $.hasClass("sp-validation-error") || (Le(!0),
                Me())
            }),
            Z.text(h.showPaletteOnly ? h.togglePaletteMoreText : h.togglePaletteLessText),
            ...
            Y.on(o, ".sp-thumb-el:nth-child(1)", {
                ignore: !0
            }, a)
        }();
        var Ee = {
            ...
            reflow: Oe,
            option: function(e, t) {
                return e === De ? Ne.extend({}, h) : t === De ? h[e] : (h[e] = t,
            ...
            destroy: function() {
                ...
                0 < e.length && e.after(O).remove(),
                Ie[Ee.id] = null
            },
            container: E
        };
        return Ee.id = Ie.push(Ee) - 1,
        Ee
    }
    function a() {}
    function Xe(e) {
    ...
    function Ge(s, i, t, e) {
        ...
        function o(e) {
            if (c) {
                if (Ve && l.documentMode < 9 && !e.button)
                    return g();
        ...
        Ne(s).on("touchstart mousedown", function(e) {
            (e.which ? 3 == e.which : 2 == e.button) || c || !1 !== t.apply(s, arguments) && (c = !0,
            f = Ne(s).height(),
            h = Ne(s).width(),
            u = Ne(s).offset(),
            Ne(l).on(a),
    ...
    Ne.fn.spectrum = function(a, e) {
        ...
        return this.each(function() {
            ...
            if (e) {
                ...
                "get" == a ? o = e.get() : "container" == a ? o = e.container : "option" == a ? o = e.option.apply(e, r) : "destroy" == a ? (e.destroy(),
                Ne(this).removeData(s)) : t.apply(e, r)
            }
        }),
        o
    }
    ...
    function() {
        var n = /^[\s,#]+/
          ...
          , h = function(e, t) {
            ...
            var a = function(e) {
                ...
                o = !0,
                r = "%" === String(e.r).substr(-1) ? "prgb" : "rgb") : e.hasOwnProperty("h") && e.hasOwnProperty("s") && e.hasOwnProperty("v") ? (e.s = F(e.s),
                e.v = F(e.v),
                t = function(e, t, a) {
                    e = 6 * z(e, 360),
                    t = z(t, 100),
                ...
                o = !0,
                r = "hsv") : e.hasOwnProperty("h") && e.hasOwnProperty("s") && e.hasOwnProperty("l") && (e.s = F(e.s),
                e.l = F(e.l),
                t = function(e, t, a) {
                    var o, r, n;
                    function s(e, t, a) {
        ...
        function d(e, t, a, o) {
            var r;
            return [R((r = o,
            Math.round(255 * parseFloat(r)).toString(16))), R(i(e).toString(16)), R(i(t).toString(16)), R(i(a).toString(16))].join("")
        }
        function a(e, t) {
            t = 0 === t ? 0 : t || 10;
            var a = h(e).toHsl();
        ...
        function m(e, t) {
            t = 0 === t ? 0 : t || 10;
            var a = h(e).toRgb();
            return a.r = f(0, u(255, a.r - i(-t / 100 * 255))),
        ...
        h.prototype = {
            ...
            toString: function(e) {
                ...
                return t || !o || "hex" !== e && "hex6" !== e && "hex3" !== e && "name" !== e ? ("rgb" === e && (a = this.toRgbString()),
        ...
        h.mix = function(e, t, a) {
            a = 0 === a ? 0 : a || 50;
            var o, r = h(e).toRgb(), n = h(t).toRgb(), s = a / 100, i = 2 * s - 1, l = n.a - r.a, c = 1 - (o = ((o = i * l == -1 ? i : (i + l) / (1 + i * l)) + 1) / 2), u = {
                r: n.r * o + r.r * c,
                g: n.g * o + r.g * c,
                b: n.b * o + r.b * c,
                a: n.a * s + r.a * (1 - s)
        ...
        var H, L, O, Q = (L = "[\\s|\\(]+(" + (H = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + H + ")[,|\\s]+(" + H + ")\\s*\\)?",
        O = "[\\s|\\(]+(" + H + ")[,|\\s]+(" + H + ")[,|\\s]+(" + H + ")[,|\\s]+(" + H + ")\\s*\\)?",
        {
